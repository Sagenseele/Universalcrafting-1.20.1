ServerEvents.recipes(event => {
    ...
    event.recipes.bloodmagic.alchemytable(
        ...
        ['occultism:datura', 'minecraft:redstone', '#forge:cobblestone', '#forge:storage_blocks/charcoal']
    ...
    // Simple Spiritual Core
    event.recipes.bloodmagic.altar('kubejs:simple_spiritual_core', 'create:andesite_alloy').upgradeLevel(0).altarSyphon(2000).consumptionRate(5).drainRate(5)
