...
StartupEvents.registry('item', event => { 
    ...
    event.create('rough_data_card_substrate').texture('kubejs:item/rough_data_card_substrate').tooltip('§bRight Click on a grindstone to get polished data card substrate.')
