...
ItemEvents.tooltip(event => {
  ...
  event.add(['mbd2:crystal_chamber'], '&bThe block in the middle of the multiblock decides, which recipe gets processed. Look in the JEI view for more information.&r')
